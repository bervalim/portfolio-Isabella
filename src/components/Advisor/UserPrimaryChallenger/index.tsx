...
function Card({ text, title }: ICard) {
  return (
    <div className="flex flex-col items-start p-6 gap-4  h-[172px] bg-[#F7F7F8]  rounded-[8px] p-[24px]  font-primary text-gray-50">
...
export function UserPrimaryChalleger() {
  return (
    <div className="container md font-display">
      ...
      <div className="grid grid-flow-col grid-rows-2 gap-[24px]">
        <Card
