  ...
  return (
    <div className="container md font-display" id="3.1">
      ...
      <p className="paragraph eleven  mt-[16px]">
        We collected all the research, requirements, and findings, then turned them into
        low-fidelity wireframes, which we validated with the Product team before refining
        them into high-fidelity wireframes and a prototype.
      </p>
      <p className="paragraph eleven  mt-[16px]">
        We also spotted an opportunity to create our own Design System during the project
        and began developing it simultaneously.
      </p>
